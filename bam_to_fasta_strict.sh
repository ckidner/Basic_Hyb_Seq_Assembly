...
# call 
bcftools mpileup -B -Ou -f Baits.fna ~/Process/Hairdrier/$bwa  | bcftools call -c -Ou | bcftools filter -i 'QUAL>160 && DP>10' -Ou | bcftools view -o tmp.vcf
